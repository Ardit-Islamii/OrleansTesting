...
namespace OrleansTesting.Grains
{
    ...
    //JournaledGrain<TState, TEvent> takes two classes, a state class and an event class and both should be serializable in order for the JournaledGrain To work. Refer to docs for more since JournaledGrain can only be of <TState> too but didn't get to understand that part.
